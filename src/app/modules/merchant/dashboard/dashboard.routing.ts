...
import { DashboardResolver, DailyTopProductsResolver, DetailedDailySalesResolver, SummarySalesResolver } from 'app/modules/merchant/dashboard/dashboard.resolvers';
