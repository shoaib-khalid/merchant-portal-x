            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(AddCategories) Disable Create button if no Parent Category selected',
                        '(UpdateProduct) Update cart items after updating/deleting products',
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(StoreCreate) Delete store if there are any error on store creation',
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    type: 'Fixed',
                    list: [
                        '(StoreManagement) Allow 12 store to be managed',
                        '(StoreCreate & Store Edit) Get city list from backend'
                    ]
                }
            ]
        },
